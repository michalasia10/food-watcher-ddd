...
from core.domain.repo.search_engine import ISearchRepository
...
class UserCrudService(BaseCrudService):
    ...
    async def create(self, input_dto: UserInputDto, **kwargs) -> UserOutputDto:
        ...
        macro = Macro.create(
            ...
            fat=input_dto.settings.fat,
            protein=input_dto.settings.macro.protein,
            carbs=input_dto.settings.macro.carbs,
            calories=input_dto.settings.macro.calories,
        )
