...
#
#     def __init__(
#         self, user_repository: UserRepository, secret_key: str, algorithm: str
#     ):
...
#             jwt.encode(payload, self._secret_key, self._algorithm), user_id
#         )
#
#     def authenticate(
...
#         try:
#             user: User = self._user_repository.get_by_field_value(
#                 "username", credentials.username
#             )
#         except NoResultFound:
#             raise UserNotFound("User not found.")
#
#         correct_password = hash_helper.verify(credentials.password, user.password)
#         if correct_password:
