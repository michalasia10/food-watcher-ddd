...
from src.modules.product.domain.entity.consumption import DailyUserConsumption as DailyUserConsumptionEntity
from src.modules.product.infra.model.consumption import DailyUserConsumption as DailyUserConsumptionModel
